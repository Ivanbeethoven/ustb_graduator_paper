...
\noindent\begin{tabularx}{\textwidth}{|>{\centering\arraybackslash}X|>{\centering\arraybackslash}X|>{\centering\arraybackslash}X|}
  ...
  2019年9月至2023年6月  & 在北京科技大学计算机科学与技术专业攻读学士学位  &    \\\hline
    &  &    \\\hline
    &   &    \\\hline
  & & \\ \hline
\end{tabularx}
...
\item 北京科技大学硕士研究生学业一等奖学金, 2025.09.
...
\item Sun C, \textbf{Han X}, Gong Y. KubeGuard: A Systematic Permission-Oriented Risk Detection Approach for Kubernetes Applications[C]//Proceedings of the 2025 IEEE International Conference on Web Services. IEEE, 2025: 855-865.
...
% 部替换为[韩晓阳] 、[论文作者学号]、[孙昌爱]。论文中上述信息均需要替换，
% 包括作者研究成果等部分的有关信息。
