...
就 CVE-2022-24877 而言，KPEDefense 生成的策略通过 CI 流水线中的 \texttt{kustomization.yaml} 校验在提交阶段拦截异常路径引用，再配合多租户权限收敛与运行时硬化限制路径穿越被利用后的影响范围。该方案可作为补丁发布前的辅助缓解措施，最终修复仍依赖升级至 \texttt{kustomize-controller v0.24.0} 及以上版本。
